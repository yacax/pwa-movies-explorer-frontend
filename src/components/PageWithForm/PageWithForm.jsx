...
function PageWithForm({
  ...
  return (
    <main className={`page-with-form page-with-form_name_${pageName}`}>
      ...
      <div className="page-with-form__bottom-container">
        <input
          type="submit"
          form={pageName}
          className={`page-with-form__button ${
            !isFormValid ? 'page-with-form__button_disabled' : ''
          }`}
          name="page-with-form__submit"
          value={submitButtonText}
          disabled={!isFormValid}
        />
        <nav className="page-with-form__navigation">
          <span className="page-with-form__link-text">
            {pageNavigationLinkComment}
          </span>
          <NavLink to={pageNavigationLink} className="page-with-form__link">
            {pageNavigationLinkText}
          </NavLink>
        </nav>
      </div>
